package com.demo.example.questionanswercardapp.network;
...
import com.demo.example.questionanswercardapp.BuildConfig;
import com.demo.example.questionanswercardapp.QuestionAnswerApplication;
...
public class NetworkChangeReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        try
        {
            if (BuildConfig.FLAVOR.equalsIgnoreCase(QuestionAnswerApplication.DEVELOPMENT_BUILD))
            {
